...
<div id="contact-links" align="center">
  <a href="https://www.linkedin.com/in/bouchra-benghazala-6b2925200/" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-blue?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn Badge"/>
  </a>
  <a href="mailto:ghazalabouchra@gmail.com">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email Badge"/>
  </a>
  <a href="https://github.com/BouchraBenGhazala" target="_blank">
...
<p align="center">
  ...
  <br>
  <strong>💬 Chatbots IA :</strong> Développement de chatbots génératifs avec RAG et fine-tuning de modèles open source (Qwen, Llama).  
  <br>
...
| :--- | :--- |
| **IA Générative & NLP** | LLMs (GPT, Gemini, LLaMA, Qwen) · RAG · LangChain · LlamaIndex · Embeddings · Fine-tuning (PEFT, LoRA) |
| **Machine Learning** | Régression · Arbres de décision · Réseaux de neurones · Clustering · PCA · LSTM · RNN |
| **Data Engineering** | Spark · Kafka · Airflow · ETL · Vector Databases (FAISS, ChromaDB) |
| **Développement** | Python (Pandas, Sklearn, TensorFlow, PyTorch, HuggingFace) · FastAPI · Flask · Streamlit |
| **Cloud & DevOps** | Docker · AWS · OCI · Git · Linux |
| **Bases de Données** | PostgreSQL · MySQL · MongoDB · Oracle |
| **DataViz** | Streamlit · Plotly · Seaborn · Matplotlib |
...
- Implémentation locale via Ollama & llama.cpp et stockage FAISS.

### 🤖 Data Scientist – 3D Smart Factory (Casablanca) (Août 2024 – Sept. 2024)
- Extraction d’informations médicales avec NLP et BioBERT.  
- Création d’un pipeline automatisé (TF-IDF, cosine similarity).  
- Déploiement API Flask & Docker.

### 💬 Data Scientist – Sygma AI (Casablanca) (Mai 2024 – Août 2024)
- Chatbot RAG pour la gestion des espaces patients.  
- Extraction multimodale via LLMs et OCR (Gemini, OpenAI).  
- Stockage distribué sur AWS S3.

---

## 🎓 Formation
🎓 **Master 2 Data Science – ISIMA** (2024–2025)  
🎓 **Ingénieur IA Informatique – ENSAM Casablanca** (2020–2025)

---

## 🏅 Certifications
- Applied Machine Learning in Python (Coursera)  
- Oracle OCI AI & Generative AI  
- AWS Cloud Foundations  
- Cisco PCAP Python & NDG Linux  
